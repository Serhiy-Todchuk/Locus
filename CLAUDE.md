...
**M6 -- Connected & Misc -- in progress.** Done: S6.10, S6.11, S6.12, S6.13, S6.15, S6.16, S6.17, S6.18 (partial -- Tasks A-G shipped, remaining items deferred), S6.19. Per-stage detail in [roadmap/M6/](roadmap/M6/); cross-cutting design rationale in [ADR-0007](architecture/decisions/0007-context-budget-reshape-lazy-manifest-and-profiles.md).
