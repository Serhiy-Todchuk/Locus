...
private:
    ...
    // User toggled the "Auto" checkbox in some tab's chat footer. Mirrors
    // the new state into workspace config, persists, and broadcasts to
    // every other open tab so they all reflect the same state.
