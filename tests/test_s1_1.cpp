...
struct StubFrontend : IFrontend {
    ...
    void on_context_meter(int used, int limit, int, int, int, long long) override {
...
struct ThrowingFrontend : IFrontend {
    ...
    void on_context_meter(int, int, int, int, int, long long) override { throw std::runtime_error("boom"); }
