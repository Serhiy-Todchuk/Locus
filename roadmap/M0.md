...
## S0.2 -- Workspace Foundation done
...
- [x] Log file always written to `.locus/locus.log` (rotating, max 10MB x 3 files)
- [x] Graceful Ctrl+C shutdown (flush log, close SQLite)

## S0.9 -- M0 Validation done
