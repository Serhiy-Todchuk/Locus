...
## S1.1 -- Core / Frontend Architecture done
...
## S1.2 -- wxWidgets Bootstrap + System Tray done
...
- [x] Source layout: `src/frontends/gui/*.h/cpp`

## S1.3 -- Chat UI + Markdown done
...
## S1.5 -- Context Compaction UI done
...
## S1.6 -- Workspace, File Tree & Settings done
