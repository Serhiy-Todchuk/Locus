...
- [x] **[S6.17](S6.17-compaction-fixes-and-tool-robustness.md)** -- Compaction Fixes + Tool-Arg Robustness **done 2026-05-27** (Tasks A/B/C/D/E/F/H/I/J/M shipped; Tasks G + L + K deferred -- not on the Pass-5 acceptance critical path).
