...
Requires [S6.3](S6.3-crow-frontend.md). No build step, no framework — keeps the static asset surface tiny and aligned with the project's anti-Electron stance.
