...
| Stage | Title | Theme |
|---|---|---|
| [S5.L](S5.L-ui-automation-driver.md) done | UI Automation Test Driver | Testing / Infra |
| [S5.B](S5.B-terminal-panel.md) done | Live Terminal Panel | UX |
| [S5.A](S5.A-capability-toggles.md) done | Workspace Capability Toggles | UX / Tokens |
