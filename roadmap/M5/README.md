...
| Done | Stage | Title | Theme |
|---|---|---|---|
| [x] | [S5.L](S5.L-ui-automation-driver.md) | UI Automation Test Driver | Testing / Infra |
| [x] | [S5.B](S5.B-terminal-panel.md) | Live Terminal Panel | UX |
| [x] | [S5.A](S5.A-capability-toggles.md) | Workspace Capability Toggles | UX / Tokens |
| [x] | [S5.M](S5.M-global-settings.md) | Global Settings Template + ~/.locus migration | UX / Config |
| [x] | [S5.C](S5.C-inline-diffs-in-chat.md) | Inline Code Diffs in Chat | UX |
| [x] | [S5.J](S5.J-llm-context-refactor.md) | LLMContext Class Refactor | Refactor |
| [x] | [S5.O](S5.O-tool-safety-hardening.md) | Tool & Filesystem Safety Hardening | Safety |
